...
namespace ImGui {
    ...
    static void processCurrentFrame(FrameIndexType *frame, ImGuiNeoSequencerInternalData &context) {
        ...
        const auto hovered = false;// ItemHoverable(pointerRect, GetCurrentWindow()->GetID("##_top_selector_neo"));
    ...
    static void
    addKeyframeToDeleteData(int32_t value, ImGuiNeoSequencerInternalData &context, const ImGuiID timelineId) {
    ...
    static bool createKeyframe(int32_t *frame) {
        ...
        bool hovered = false; //ItemHoverable(bb, id);
...
//
        ...
        *end = endFrameVal;
        ...
        const bool hovered = false; //ItemHoverable(bb, GetCurrentWindow()->GetID("##zoom_slider"));
